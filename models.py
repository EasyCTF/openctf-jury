...
class Problem:
    def __init__(self, id: int, last_modified: int, test_cases: int, time_limit: float, memory_limit: int,
...
class Job:
    def __init__(self, id: int, problem: Problem, verification_code: int, code: str, language):
        self.id = id
